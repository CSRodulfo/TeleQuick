CREATE TABLE [dbo].[InvoiceHeaders] (
    ...
    CONSTRAINT [FK_InvoiceHeaders_Vehicles_VehicleId] FOREIGN KEY ([VehicleId]) REFERENCES [dbo].[Vehicles] ([Id])
);


GO
CREATE NONCLUSTERED INDEX [IX_InvoiceHeaders_VehicleId]
    ON [dbo].[InvoiceHeaders]([VehicleId] ASC);
